...
float factorizeArray(float array[NB_rows_MAX][NB_col_MAX], float new_array[NB_rows_MAX][NB_col_MAX], int rows, int columns, int index);
float determinant(float array[NB_rows_MAX][NB_col_MAX], int rows, int columns);
